...
public class UniversalImageLoader {
    ...
    public ImageLoaderConfiguration getConfig() {
        DisplayImageOptions defaultOpts = new DisplayImageOptions.Builder()
        ...
        ImageLoaderConfiguration imageLoaderConfiguration = new ImageLoaderConfiguration.Builder(mContext)
                .defaultDisplayImageOptions(defaultOpts)
    ...
    public static void setImage(String imageURI, ImageView imageView, final ProgressBar progressBar, String append){
